...
export const ASSIGN_ISSUE_TO_USER_REQUEST = "ASSIGN_ISSUE_TO_USER_REQUEST";
export const ASSIGN_ISSUE_TO_USER_SUCCESS = "ASSIGN_ISSUE_TO_USER_SUCCESS";
export const ASSIGN_ISSUE_TO_USER_FAILURE = "ASSIGN_ISSUE_TO_USER_FAILURE";
